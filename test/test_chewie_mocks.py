...
class ChewieWithMocksTestCase(asynctest.TestCase):
    ...
    async def test_eap_packet_in_goes_to_new_state_machine(self, state_machine, 
    ...
    async def test_eap_output_packet_gets_packed_and_sent(self, 
    ...
    async def test_radius_packet_in_goes_to_state_machine(self, state_machine, 
